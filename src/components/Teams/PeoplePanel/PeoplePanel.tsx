...
export function PeoplePanel() {
  ...
  const filteredBySearch = filterPeopleBySearch(people, search)
  const filteredPeople = filterPeopleByRole(filteredBySearch, roleFilter || null)
  const uniqueRoles = getUniqueRoles(people)
  ...
  return (
    <div className="people-panel">
      <header className="people-panel__header">
        <h2 className="people-panel__title">Teams Library</h2>
      </header>
      ...
      {uniqueRoles.length > 0 && (
        <div className="people-panel__filter">
          <RoleFilter roles={uniqueRoles} value={roleFilter} onChange={setRoleFilter} />
        </div>
      )}

      <div className="people-panel__actions">
        <button
          type="button"
          className="people-panel__btn people-panel__btn--add"
        ...
        <button
          type="button"
          className="people-panel__btn people-panel__btn--secondary"
        ...
        <button
          type="button"
          className="people-panel__btn people-panel__btn--import"
        ...
        <input
          ...
          className="people-panel__file-input"
      ...
      <div className="people-panel__tree-wrap">
        <PeopleTree
          ...
          onRenameCancel={() => { setEditingNodeId(null); setEditingValue('') }}
        />
      </div>

      <div className="people-panel__footer">
        <div className="people-panel__footer-buttons">
          {selectedCount >= 2 && (
            <button
              type="button"
              className="people-panel__save-group-btn"
          ...
          {selectedCount >= 1 && (
            <div className="people-panel__footer-actions">
              <button
                type="button"
                className="people-panel__footer-btn"
              ...
              <button
                type="button"
                className="people-panel__footer-btn people-panel__footer-btn--danger"
        ...
        <div className="people-panel__footer-scroll">
          <SavedGroups
            groups={savedGroups}
            people={people}
      ...
      {showAddModal && (
        <AddPersonModal
          onClose={() => { setShowAddModal(false); setAddPersonPreFill({}); setEditingPerson(null) }}
          onAdd={handleAddPerson}
          onUpdate={handleUpdatePerson}
          initialCompany={addPersonPreFill.company}
          initialTeam={addPersonPreFill.team}
